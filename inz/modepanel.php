<?php
	...
	if((isset($_GET['prod_id'])) && (isset($_GET['accept'])))
	{
		require_once "conn.php";
		mysqli_report(MYSQLI_REPORT_STRICT);
		try 
		{
			...
			{
				$upd_string = "UPDATE products set is_accepted='1' where id_prod=".$_GET['prod_id']."";
